...
public class BlogPost {
	...
	//ID Labels the next variable as being our primary key when stored to our database.
	...
	public BlogPost(String title, String author, String blogEntry) {
		super(); //What this line does is it calls the superclasses default constructor
				//Effectively calls the default constructor on Java.lang.Object which we inherit 
				//from implicitly
		this.title = title; 
		this.author=author;
